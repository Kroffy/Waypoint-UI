...
function NS:Load()
	...
	do
		...
		L["Config - WaypointSystem - Pinpoint - Detail - Description"] = "包含额外的信息，例如名称/描述。"
		...
		L["Config - Appearance - Waypoint - Scale - Min - Decsription"] = "可缩小到的最小百分比。"
