...
function NS:Load()
	...
	do
		...
		L["Config - Appearance - WaypointSystem - General"] = "Общие"
		L["Config - Appearance - WaypointSystem - General - Transition Distance"] = "Точное расстояние"
		L["Config - Appearance - WaypointSystem - General - Transition Distance - Description"] = "Показано максимальное расстояние до точечного обнаружения."
		L["Config - Appearance - WaypointSystem - General - Hide Distance"] = "Минимальное расстояние"
		L["Config - Appearance - WaypointSystem - General - Hide Distance - Description"] = "Расстояние до точки маршрута/точке привязки скрыто."
		...
		L["Config - Appearance - WaypointSystem - WaypointScale - Description"] = "Размер точки маршрута меняется в зависимости от расстояния. Эта опция задает общий размер."
		L["Config - Appearance - WaypointSystem - WaypointMinScale"] = "Минимум %"
		L["Config - Appearance - WaypointSystem - WaypointMinScale - Description"] = "Минимальный % размер, до которого можно уменьшить."
		L["Config - Appearance - WaypointSystem - WaypointMaxScale"] = "Максимум %"
		L["Config - Appearance - WaypointSystem - WaypointMaxScale - Description"] = "Максимальный % размер, до которого можно увеличить."
